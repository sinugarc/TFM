...
qc.rx(0.7853981633974483,q[4])
qc.h(q[4])
qc.cu1(pi/2**(1), q[4], q[5])
qc.h(q[5])


with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/142AddGate_rx_inGap_8_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()