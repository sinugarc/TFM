...
qc.rxx(0.7853981633974483,q[0], q[5])
qc.swap(q[0], q[5])
qc.swap(q[1], q[4])
qc.swap(q[2], q[3])
qc.h(q[0])
...
with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/15AddGate_rxx_inGap_1_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()