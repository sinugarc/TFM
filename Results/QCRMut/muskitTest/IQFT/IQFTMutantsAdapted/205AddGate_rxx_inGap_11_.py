...
qc.rxx(0.7853981633974483,q[2],q[1])

with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/205AddGate_rxx_inGap_11_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()