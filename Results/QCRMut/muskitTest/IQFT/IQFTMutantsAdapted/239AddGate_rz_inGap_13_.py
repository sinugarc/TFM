...
qc.rz(0.7853981633974483,q[3])

with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/239AddGate_rz_inGap_13_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()