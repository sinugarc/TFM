...
qc.ry(0.7853981633974483,q[0])

with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/181AddGate_ry_inGap_10_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()