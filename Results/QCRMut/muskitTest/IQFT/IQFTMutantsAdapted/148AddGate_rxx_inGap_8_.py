...
qc.rxx(1.5707963267948966, q[5], q[4])
qc.h(q[4])
qc.cu1(pi/2**(1), q[4], q[5])
qc.h(q[5])


with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/148AddGate_rxx_inGap_8_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()