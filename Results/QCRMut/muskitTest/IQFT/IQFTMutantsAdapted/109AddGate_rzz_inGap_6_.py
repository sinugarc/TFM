...
qc.rzz(0.7853981633974483, q[3], q[2])
qc.h(q[2])
...
with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/109AddGate_rzz_inGap_6_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()