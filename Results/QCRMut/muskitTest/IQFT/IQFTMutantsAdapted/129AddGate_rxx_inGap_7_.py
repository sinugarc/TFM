...
qc.rxx(0.7853981633974483, q[4], q[3])
qc.h(q[3])
...
with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/129AddGate_rxx_inGap_7_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()