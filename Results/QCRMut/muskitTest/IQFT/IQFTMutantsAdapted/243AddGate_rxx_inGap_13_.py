...
qc.rxx(1.5707963267948966,q[4],q[3])

with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/243AddGate_rxx_inGap_13_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()