...
qc.rxx(0.7853981633974483,q[4],q[5])

with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/281AddGate_rxx_inGap_15_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()