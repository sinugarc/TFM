...
qc.rzz(3.141592653589793, q[4], q[5])
qc.h(q[5])


with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/166AddGate_rzz_inGap_9_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()