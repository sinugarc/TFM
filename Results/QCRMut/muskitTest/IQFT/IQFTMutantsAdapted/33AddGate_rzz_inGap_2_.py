...
qc.swap(q[0], q[5])
qc.rzz(3.141592653589793,q[1], q[4])
qc.swap(q[1], q[4])
qc.swap(q[2], q[3])
qc.h(q[0])
...
with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/33AddGate_rzz_inGap_2_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()