...
qc.rzz(3.141592653589793,q[3],q[2])

with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/223AddGate_rzz_inGap_12_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()