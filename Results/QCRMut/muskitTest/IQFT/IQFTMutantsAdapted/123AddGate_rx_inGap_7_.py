...
with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/123AddGate_rx_inGap_7_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()