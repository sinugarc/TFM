...
qc.swap(q[1], q[4])
qc.swap(q[2], q[3])
qc.rxx(3.141592653589793, q[1], q[0])
qc.h(q[0])
...
with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/72AddGate_rxx_inGap_4_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()