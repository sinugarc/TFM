...
qc.rx(3.141592653589793,q[4])

with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/256AddGate_rx_inGap_14_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()