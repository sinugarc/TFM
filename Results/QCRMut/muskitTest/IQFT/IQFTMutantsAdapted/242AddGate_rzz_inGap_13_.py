...
qc.rzz(3.141592653589793,q[4],q[3])

with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/242AddGate_rzz_inGap_13_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()