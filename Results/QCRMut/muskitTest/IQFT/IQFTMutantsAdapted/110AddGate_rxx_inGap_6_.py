...
qc.rxx(1.5707963267948966, q[3], q[2])
qc.h(q[2])
...
with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/110AddGate_rxx_inGap_6_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()