...
qc.rzz(1.5707963267948966,q[1],q[0])

with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/185AddGate_rzz_inGap_10_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()