...
qc.rzz(1.5707963267948966,q[4],q[5])

with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/280AddGate_rzz_inGap_15_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()