...
qc.rz(3.141592653589793,q[5])

with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/277AddGate_rz_inGap_15_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()