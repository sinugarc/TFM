...
qc.rx(1.5707963267948966,q[5])
qc.h(q[5])


with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/161AddGate_rx_inGap_9_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()