...
qc.rzz(1.5707963267948966,q[5],q[4])

with gzip.open('/srv/home/sinugarc/TFM/Repl/QCRMutExp/muskitTest/IQFT/IQFTMutantsPGZ/261AddGate_rzz_inGap_14_.pgz',mode='wb') as f:
    pickle.dump(qc,f)
f.close()