...
Automatic generation of test circuits for the verification of Quantum deterministic algorithms \cite{garcia2022automatic}

2023 version \cite{garcia4421955automatic}

\vspace{15pt}
\subsection{Coverage Criteria for Quantum Software Testing; 01 March 2023}

Formalization of Structural Test Cases Coverage Criteria for Quantum Software Testing \cite{kumar2023formalization}

\vspace{15pt}
\subsection{QP testing subroutines; 30 Jun 2023}

Testing multi-subroutine quantum programs: From unit testing to integration testing \cite{long2023testing}

\subsection{QP black-box testing; 4 Jul 2023}
